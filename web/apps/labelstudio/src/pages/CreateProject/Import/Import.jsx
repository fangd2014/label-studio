    ...
    <div className={importClass}>
      ...
      <header className="flex gap-4">
        ...
        >
          ...
          <label>
            <input {...csvProps} value="ts" checked={csvHandling === "ts"} /> 时间序列或整篇文本文件
          </label>
        </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <Tooltip title="视频格式支持取决于你的浏览器。点击了解更多。">
                            <a
                              ...
                              aria-label="了解更多视频格式支持信息（新标签页打开）"
                            >
                      ...
                      <ul className="mt-2 ml-4 list-disc font-normal">
                        ...
                        <li>
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="多图像标注文档（新标签页打开）"
                          >
                            多图像标注
                          </a>
                          。JSONL 或 Parquet（仅 Enterprise）文件需要通过云存储导入。
                        </li>
                        <li>
                          查看文档以{" "}
