...
export const EMPTY_SUBMIT_TOOLTIP = "当前项目不允许提交空标注";
export const INCOMPLETE_SUBMIT_TOOLTIP = "请先完成所有区域后再提交";
export const INCOMPLETE_UPDATE_TOOLTIP = "请先完成所有区域后再更新";
export const INCOMPLETE_ACCEPT_TOOLTIP = "请先完成所有区域后再接受";
